...
write_stats(tagStats, "xml_siblings/tagnames_unique.csv")
unused = unused_tags(tagStats)
siblings = extract_siblings(docTranscripts)
neighbors = extract_neighbours(docTranscripts)
write_stats(siblings, "xml_siblings/sibling.csv")
write_stats(neighbors, "xml_siblings/neighbors.csv")
new_siblings, len_siblings = clean_all_siblings(docTranscripts)
write_stats(new_siblings, "xml_siblings/all_siblings.csv")
with open('xml_siblings/siblings_by_len.csv', 'w') as f:
